...
(function (global, factory) {
  ...
  Vex$1.getCanvasContext = function(canvas_sel) {
    ...
    if (!(canvas && canvas.getContext)) {
      throw new Vex$1.RERR("UnsupportedBrowserError",
  ...
  */
  Flow.keyProperties = function(key, clef, params) {
    ...
    if (pieces.length < 2) {
      throw new Vex$1.RERR("BadArguments",
  ...
  Flow.integerToNote = function(integer) {
    ...
    if (!noteValue)
      throw new Vex$1.RERR("BadArguments", "Unknown note value for integer: " +
          integer);
  ...
  Flow.keySignature = function(spec) {
    ...
    if (!keySpec) {
      throw new Vex$1.RERR("BadKeySignature",
  ...
  var SVGContext = (function() {
    ...
    SVGContext.addPrefix = Vex$1.Prefix;
    ...
    Voice.prototype = {
      ...
      draw: function(context, stave) {
        ...
        for (var i = 0; i < this.tickables.length; ++i) {
          ...
          if (!tickable.getStave()) {
            throw new Vex$1.RuntimeError("MissingStave",
  ...
  var Glyph = (function() {
    ...
    Glyph.prototype = {
      ...
      getMetrics: function() {
        if (!this.metrics) throw new Vex$1.RuntimeError("BadGlyph", "Glyph " +
    ...
    Glyph.loadMetrics = function(font, code, cache) {
      ...
      if (!glyph) throw new Vex$1.RuntimeError("BadGlyph", "Glyph " + code +
      ...
      if (glyph.o) {
        ...
        throw new Vex$1.RuntimeError("BadGlyph", "Glyph " + this.code +
  ...
  var Stem = (function() {
    ...
    function L() { if (Stem.DEBUG) Vex$1.L("Vex.Flow.Stem", arguments); }
    ...
    Stem.prototype = {
      ...
      draw: function() {
        if (!this.context) throw new Vex$1.RERR("NoCanvasContext",
  ...
  var Beam = (function() {
    ...
    Beam.generateBeams = function(notes, config) {
      ...
      var tickGroups = config.groups.map(function(group) {
        if (!group.multiply) {
          throw new Vex$1.RuntimeError("InvalidBeamGroups",
  ...
  var StaveConnector = (function() {
    ...
    StaveConnector.prototype = {
      ...
      draw: function() {
        if (!this.ctx) throw new Vex$1.RERR(
    ...
    function drawBoldDoubleLine(ctx, type, topX, topY, botY){
      if (type !== StaveConnector.type.BOLD_DOUBLE_LEFT &&
        ...
        throw Vex$1.RERR("InvalidConnector",
  ...
  var Note = (function() {
    ...
    Vex$1.Inherit(Note, Tickable, {
      ...
      getYs: function() {
        if (this.ys.length === 0) throw new Vex$1.RERR("NoYValues",
      ...
      getYForTopText: function(text_line) {
        if (!this.stave) throw new Vex$1.RERR("NoStave",
      ...
      getModifierStartXY: function() {
        if (!this.preFormatted) throw new Vex$1.RERR("UnformattedNote",
      ...
      getX: function() {
        if (!this.tickContext) throw new Vex$1.RERR("NoTickContext",
  ...
  var NoteHead = (function() {
    ...
    Vex$1.Inherit(NoteHead, Note, {
      init: function(head_options) {
        ...
        Vex$1.Merge(this.render_options, {
  ...
  var StemmableNote = (function(){
    var StemmableNote = function(note_struct) {
      if (arguments.length > 0) this.init(note_struct);
    };

    // To enable logging for this class. Set `Vex.Flow.StemmableNote.DEBUG` to `true`.
    function L() { if (StemmableNote.DEBUG) Vex$1.L("Vex.Flow.StemmableNote", arguments); }

    Vex$1.Inherit(StemmableNote, Note, {
      init: function(note_struct){
      ...
      setStemDirection: function(direction) {
        ...
        if (direction != Stem.UP &&
            direction != Stem.DOWN) {
          throw new Vex$1.RERR("BadArgument", "Invalid stem direction: " +
              direction);
        }
      ...
      getStemExtents: function() {
        if (!this.ys || this.ys.length === 0) throw new Vex$1.RERR("NoYValues",
      ...
      getYForTopText: function(text_line) {
        ...
        if (this.hasStem()) {
          return Vex$1.Min(this.stave.getYForTopText(text_line),
      ...
      getYForBottomText: function(text_line) {
        var extents = this.getStemExtents();
        if (this.hasStem()) {
          return Vex$1.Max(this.stave.getYForTopText(text_line),
  ...
  var Modifier = (function() {
    ...
    function L() { if (Modifier.DEBUG) Vex$1.L("Vex.Flow.Modifier", arguments); }
    ...
    Modifier.prototype = {
      ...
      draw: function() {
        if (!this.context) throw new Vex$1.RERR("NoCanvasContext",
            "Can't draw without a canvas context.");
        throw new Vex$1.RERR("MethodNotImplemented",
  ...
  var Dot = (function() {
    ...
    Vex$1.Inherit(Dot, Modifier, {
      ...
      draw: function() {
        if (!this.context) throw new Vex$1.RERR("NoContext",
          "Can't draw dot without a context.");
        if (!(this.note && (this.index != null))) throw new Vex$1.RERR("NoAttachedNote",
  ...
  var StaveNote = (function() {
    ...
    function L() { if (StaveNote.DEBUG) Vex$1.L("Vex.Flow.StaveNote", arguments); }
    ...
    StaveNote.formatByY = function(notes, state) {
      ...
      if (!hasStave) throw new Vex$1.RERR("Stave Missing",
    ...
    // ## Prototype Methods
    //
    Vex$1.Inherit(StaveNote, StemmableNote, {
      init: function(note_struct) {
      ...
      calculateKeyProps: function() {
        ...
        this.keyProps.forEach(function(key) {
          if (key.line < lastLine) {
            Vex$1.W("Unsorted keys in note will be sorted. " +
      ...
      getLineNumber: function(is_top_note) {
        if(!this.keyProps.length) throw new Vex$1.RERR("NoKeyProps",
      ...
      setStave: function(stave) {
        var superclass = StaveNote.superclass;
  ...
  var FretHandFinger = (function() {
    ...
    Vex$1.Inherit(FretHandFinger, Modifier, {
      ...
      getRelativeNoteName: function(root, noteValue) {
        ...
        if (Math.abs(interval) > Music.NUM_TONES - 3) {
          ...
          if (Math.abs(reverse_interval) > 2) {
            throw new Vex$1.RERR("BadArguments", "Notes not related: " + root + ", " +
                              noteValue);
          } else {
  ...
  var Accidental = (function(){
    ...
    function L() { if (Accidental.DEBUG) Vex$1.L("Vex.Flow.Accidental", arguments); }
    ...
    // `ModifierContext`.
    Vex$1.Inherit(Accidental, Modifier, {
      ...
      init: function(type) {
        ...
        if (!this.accidental) throw new Vex$1.RERR("ArgumentError", "Unknown accidental type: " + type);
    ...
    StaveTie.prototype = {
      ...
      setNotes: function(notes) {
        ...
        if (notes.first_indices.length != notes.last_indices.length)
          throw new Vex$1.RuntimeError("BadArguments", "Tied notes must have similar" +
          " index sizes");
  ...
  var GraceNoteGroup = (function(){
    ...
    function L() { if (GraceNoteGroup.DEBUG) Vex$1.L("Vex.Flow.GraceNoteGroup", arguments); }
    ...
    // `ModifierContext`.
    Vex$1.Inherit(GraceNoteGroup, Modifier, {
      ...
      draw: function() {
        if (!this.context)  {
          throw new Vex$1.RuntimeError("NoContext",
        ...
        if (!(note && (this.index !== null))) {
          throw new Vex$1.RuntimeError("NoAttachedNote",
  ...
  var StringNumber = (function() {
    ...
    // ## Prototype Methods
    Vex$1.Inherit(StringNumber, Modifier, {
      init: function(number) {
  ...
  var Articulation = (function() {
    ...
    function L() { if (Articulation.DEBUG) Vex$1.L("Vex.Flow.Articulation", arguments); }
    ...
    // ## Prototype Methods
    Vex$1.Inherit(Articulation, Modifier, {
      ...
      init: function(type) {
        ...
        if (!this.articulation) throw new Vex$1.RERR("ArgumentError",
  ...
  var Ornament = (function() {
    ...
    function L() { if (Ornament.DEBUG) Vex$1.L("Vex.Flow.Ornament", arguments); }
    ...
    // ## Prototype Methods
    Vex$1.Inherit(Ornament, Modifier, {
      ...
      init: function(type) {
        ...
        if (!this.ornament) throw new Vex$1.RERR("ArgumentError",
  ...
  var Annotation = (function() {
    ...
    function L() { if (Annotation.DEBUG) Vex$1.L("Vex.Flow.Annotation", arguments); }
    ...
    Vex$1.Inherit(Annotation, Modifier, {
      ...
      draw: function() {
        ...
        if (!this.note) throw new Vex$1.RERR("NoNoteForAnnotation",
  ...
  var Bend = (function() {
    ...
    Vex$1.Inherit(Bend, Modifier, {
      ...
      draw: function() {
        ...
        if (!(this.note && (this.index != null))) throw new Vex$1.RERR("NoNoteForBend",
  ...
  var Vibrato = (function() {
    ...
    // ## Prototype Methods
    Vex$1.Inherit(Vibrato, Modifier, {
      init: function() {
      ...
      draw: function() {
        ...
        if (!this.note) throw new Vex$1.RERR("NoNoteForVibrato",
  ...
  var ModifierContext = (function() {
    function ModifierContext() {
      ...
      this.POSTFORMAT = [ Vex$1.Flow.StaveNote ];
    }

    // To enable logging for this class. Set `Vex.Flow.ModifierContext.DEBUG` to `true`.
    function L() { if (ModifierContext.DEBUG) Vex$1.L("Vex.Flow.ModifierContext", arguments); }
    ...
    ModifierContext.prototype = {
      ...
      getMetrics: function() {
        if (!this.formatted) throw new Vex$1.RERR("UnformattedModifier",
  ...
  var Formatter = (function() {
    ...
    function L() { if (Formatter.DEBUG) Vex$1.L("Vex.Flow.Formatter", arguments); }
    ...
    function createContexts(voices, context_type, add_fn) {
      if (!voices || !voices.length) throw new Vex$1.RERR("BadArgument",
          "No voices to format");
      ...
      for (i = 0; i < voices.length; ++i) {
        ...
        if (!(voice.getTotalTicks().equals(totalTicks))) {
          throw new Vex$1.RERR("TickMismatch",
              "Voices should have same total note duration in ticks.");
        }

        if (voice.getMode() == Voice.Mode.STRICT && !voice.isComplete())
          throw new Vex$1.RERR("IncompleteVoice",
      ...
      return {
        ...
        array: contexts,
        list: Vex$1.SortAndUnique(tickList, function(a, b) { return a - b; },
    ...
    Formatter.prototype = {
      ...
      preCalculateMinTotalWidth: function(voices) {
        ...
        if (!this.tContexts) {
          if (!voices) {
            throw new Vex$1.RERR("BadArgument",
      ...
      getMinTotalWidth: function() {
        if (!this.hasMinTotalWidth) {
          throw new Vex$1.RERR("NoMinTotalWidth",
  ...
  var Barline = (function() {
    ...
    Vex$1.Inherit(Barline, StaveModifier, {
      init: function(type) {
      ...
      drawVerticalBar: function(stave, x, double_bar) {
        if (!stave.context) throw new Vex$1.RERR("NoCanvasContext",
  ...
  var Repetition = (function() {
    ...
    Vex$1.Inherit(Repetition, StaveModifier, {
  ...
  var StaveSection = (function() {
    ...
    Vex$1.Inherit(StaveSection, StaveModifier, {
      ...
      draw: function(stave, shift_x) {
        if (!stave.context) throw new Vex$1.RERR("NoContext",
    ...
    Vex$1.Inherit(TextNote, Note, {
      init: function(text_struct) {
        ...
        if (this.glyph_type) {
          ...
          if (!struct) throw new Vex$1.RERR("Invalid glyph type: " + this.glyph_type);
      ...
      // Pre-render formatting
      preFormat: function() {
        if (!this.context) throw new Vex$1.RERR("NoRenderContext",
      ...
      draw: function(stave) {
        ...
        switch(this.position) {
          ...
          case Position.BELOW:
            ...
            break;
          default:
            throw new Vex$1.RERR("InvalidPosition",
  ...
  var Clef = (function() {
    ...
    function L() { if (Clef.DEBUG) Vex$1.L("Vex.Flow.Clef", arguments); }
    ...
    // ## Prototype Methods
    Vex$1.Inherit(Clef, StaveModifier, {
  ...
  var KeySignature = (function() {
    ...
    // ## Prototype Methods
    Vex$1.Inherit(KeySignature, StaveModifier, {
  ...
  var TimeSignature = (function() {
    ...
    Vex$1.Inherit(TimeSignature, StaveModifier, {
      ...
      parseTimeSpec: function(timeSpec) {
        ...
        for (i = 0; i < timeSpec.length; ++i) {
          ...
          if (c == "/") {
            ...
            throw new Vex$1.RERR("BadTimeSignature",
  ...
  var Volta = (function() {
    ...
    Vex$1.Inherit(Volta, StaveModifier, {
  ...
  var Stave = (function() {
    ...
    Stave.prototype = {
      ...
      getModifierXShift: function(index) {
        if (typeof index !== 'number') new Vex$1.RERR("InvalidIndex",
      ...
      setConfigForLine: function(line_number, line_config) {
        if (line_number >= this.options.num_lines || line_number < 0) {
          throw new Vex$1.RERR("StaveConfigError",
  ...
  var TabStave = (function() {
    function TabStave(x, y, width, options) {
      if (arguments.length > 0) this.init(x, y, width, options);
    }

    Vex$1.Inherit(TabStave, Stave, {
      init: function(x, y, width, options) {
        var tab_options = {
  ...
  var TimeSigNote = (function() {
    function TimeSigNote(timeSpec, customPadding) {
      if (arguments.length > 0) this.init(timeSpec, customPadding);
    }

    Vex$1.Inherit(TimeSigNote, Note, {
      init: function(timeSpec, customPadding) {
  ...
  var GraceNote = (function() {
    ...
    Vex$1.Inherit(GraceNote, StaveNote, {
      init: function(note_struct) {
    ...
    Tuning.prototype = {
      ...
      getValueForString: function(stringNum) {
        ...
        if (s < 1 || s > this.numStrings)
          throw new Vex$1.RERR("BadArguments", "String number must be between 1 and " +
      ...
      getValueForFret: function(fretNum, stringNum) {
        ...
        if (f < 0) {
          throw new Vex$1.RERR("BadArguments", "Fret number must be 0 or higher: " +
              fretNum);
        }
  ...
  var TextDynamics = (function(){
    function TextDynamics(text_struct) {
      if (arguments.length > 0) this.init(text_struct);
    }

    // To enable logging for this class. Set `Vex.Flow.TextDynamics.DEBUG` to `true`.
    function L() { if (TextDynamics.DEBUG) Vex$1.L("Vex.Flow.TextDynamics", arguments); }
    ...
    // within a `Voice`.
    Vex$1.Inherit(TextDynamics, Note, {
  ...
  var StaveLine = (function() {
    ...
    StaveLine.prototype = {
      ...
      setNotes: function(notes) {
        ...
        if (notes.first_indices.length != notes.last_indices.length)
          throw new Vex$1.RuntimeError("BadArguments", "Connected notes must have similar" +
            " index sizes");
  ...
  var PedalMarking = (function() {
    ...
    function L() { if (PedalMarking.DEBUG) Vex$1.L("Vex.Flow.PedalMarking", arguments); }
    ...
    PedalMarking.prototype =  {
      ...
      setStyle: function(style){
        if (style < 1 && style > 3)  {
          throw new Vex$1.RERR("InvalidParameter",
      ...
      drawBracketed: function() {
        ...
        this.notes.forEach(function(note, index, notes) {
          ...
          if (x < prev_x) throw new Vex$1.RERR('InvalidConfiguration',
  ...
  var TextBracket = (function() {
    ...
    function L() { if (TextBracket.DEBUG) Vex$1.L("Vex.Flow.TextBracket", arguments); }
  ...
  var BarNote = (function() {
    function BarNote() { this.init(); }

    // To enable logging for this class. Set `Vex.Flow.BarNote.DEBUG` to `true`.
    function L() { if (BarNote.DEBUG) Vex$1.L("Vex.Flow.BarNote", arguments); }

    // ## Prototype Methods
    Vex$1.Inherit(BarNote, Note, {
      init: function() {
  ...
  var Tremolo = (function() {
    ...
    Vex$1.Inherit(Tremolo, Modifier, {
      init: function(num) {
  ...
  var Crescendo = (function() {
    function Crescendo(note_struct) {
      if (arguments.length > 0) this.init(note_struct);
    }

    // To enable logging for this class. Set `Vex.Flow.Crescendo.DEBUG` to `true`.
    function L() { if (Crescendo.DEBUG) Vex$1.L("Vex.Flow.Crescendo", arguments); }
